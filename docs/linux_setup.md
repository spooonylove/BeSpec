...
### Wayland vs. X11
BeSpec runs natively on Wayland. If you experience window decoration issues (missing borders), you can force XWayland mode by setting this environment variable before launching:
```bash
